...
process_files () {
    ...
    docker exec -i timesketch-worker /bin/bash -c "log2timeline.py --status_view window --parser "!filestat" --storage_file /usr/share/timesketch/upload/plaso/$SYSTEM.plaso /usr/share/timesketch/upload/$SYSTEM"
